    ...
    for bias in biases:
        ...
        for distance in distances:
            ...
            if bias_type == "measurement_vs_data_qubit":
                if (
                    code_name == "Gauge2HoneycombCode"
                    or code_name == "Gauge2FloquetColourCode"
                ):
                    code = constructor(distance, 2)
                    gauge = 2
                elif (
                    code_name == "Gauge3HoneycombCode"
                    or code_name == "Gauge3FloquetColourCode"
                ):
                    gauge = 3
                    code = constructor(distance, 3)
                elif (
                    code_name == "Gauge4HoneycombCode"
                    or code_name == "Gauge4FloquetColourCode"
                ):
                    gauge = 4
                    code = constructor(distance, 4)
                elif (
                    code_name == "Gauge5HoneycombCode"
                    or code_name == "Gauge5FloquetColourCode"
                ):
                    gauge = 5
...
def main(
    ...
    if code_name == "HoneycombCode":
        ...
        code_name == "Gauge2HoneycombCode"
        or code_name == "Gauge3HoneycombCode"
        or code_name == "Gauge4HoneycombCode"
        or code_name == "Gauge5HoneycombCode"
    ):
        code_constructor = GaugeHoneycombCode
    elif (
        code_name == "Gauge2FloquetColourCode"
        or code_name == "Gauge3FloquetColourCode"
        or code_name == "Gauge4FloquetColourCode"
        or code_name == "Gauge5FloquetColourCode"
    ):
    ...
    for bias, tasks in bias_tasks.items():
        samples = sinter.collect(
            ...
            print_progress=True,
            save_resume_filepath=f"./resume_18_9/data_{code_name}.csv",
        )
...
if __name__ == "__main__":
    ...
    max_n_shots = 10_000
    max_n_errors = 100
    bias_ps_dict = {(9999,): np.linspace(0.008, 0.012, 2)}
